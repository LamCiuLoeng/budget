...
from budget.model.sysutil import UploadObject
reload(sys)
...
__all__ = ["gs", "filterAndSorted", "tabFocus", "Date2Text", "getOr404", "sendEmail", "advancedSendMail", "number2alphabet", "alphabet2number", "serveFile", "null2blank",
            "rpacEncrypt", "rpacDecrypt", "sysUpload", "OrderedDict", "makeException", "logError",
           "OrderedSet", "ReportGenerationException", "createToken", ]


gs = lambda kw, *ns : map(lambda n : kw.get(n, None), ns)


filterAndSorted = lambda  prefix, kw: sorted(filter(lambda (k, v): k.startswith(prefix), kw.iteritems()), cmp = lambda x, y:cmp(x[0], y[0]))
