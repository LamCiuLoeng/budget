...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="176" valign="top" align="left"><a href="#" onclick="$('form').submit();"><img src="/images/images/menu_save_g.jpg"/></a></td>
...
<div style="margin: 10px 0px; overflow: hidden;">
  <div style="float: left;">
    ...
    %elif type=="sample_profile":
    <div>
      <form name="sampleProfileForm" class="tableform" method="post" action="/access/save_new">
        <input type="hidden" name="type" value="sample_profile"/>
        <div class="case-list-one">
          <div class="case-list">
            <ul>
              <li class="label">
                <label for="name" class="fieldlabel">Sample Profile Name</label>
              </li>
              <li>
                <input type="text" id="name" name="name" class="textfield" style="width: 250px;"/>
              </li>
            </ul>
            <ul>
              <li class="label">
              ...
              <li>
                <textarea class="textarea" name="description" cols="30" rows="2" id="description"></textarea>
              </li>
            </ul>
          </div>
        </div>
        <div class="case-list-one">
          <div class="case-list">
            <input type="submit" name="submit" value="Save Profile" class="submitbutton" id="sample_profile_submit"/>
            <input type="reset" name="reset" value="Reset" class="resetbutton" id="sample_profile_reset"/>
          </div>
        </div>
        <div style="clear: both;"><br/>
        </div>
    ...
    %elif type=="dba_profile":
    <div>
      <form name="DBAProfileForm" class="tableform" method="post" action="/access/save_new">
        <input type="hidden" name="type" value="dba_profile"/>
        <div class="case-list-one">
          <div class="case-list">
            <ul>
              <li class="label">
                <label for="name" class="fieldlabel">DBA Profile Name</label>
              </li>
              <li>
                <input type="text" id="name" name="name" class="textfield" style="width: 250px;"/>
              </li>
        ...
        <div class="case-list-one">
          <div class="case-list">
            <input type="submit" name="submit" value="Save Profile" class="submitbutton" id="dba_profile_submit"/>
            <input type="reset" name="reset" value="Reset" class="resetbutton" id="dba_profile_reset"/>
          </div>
        </div>
        <div style="clear: both;"><br/>
        </div>
