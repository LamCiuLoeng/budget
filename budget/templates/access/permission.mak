...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/add?type=permission"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
<div class="nav-tree">Access&nbsp;&nbsp;&gt;&nbsp;&nbsp;Permission Management</div>

<div>
	${widget(action="/access/permission",value=values)|n}
</div>
...
%if result:
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
			<tr>
				<th width="300">Permission Name</th><th width="500">Including Group(s)</th>
			</tr>
		</thead>
		<tbody>
			%for p in result:
			<tr>
				<td><a href="/access/permission_manage?id=${p.permission_id}">${p.permission_name}</a>&nbsp;</td>
				<td>${",".join([g.group_name for g in p.groups])}&nbsp;</td>
			</tr>
			%endfor
			%if my_page.item_count > 0 :
      <tr>
