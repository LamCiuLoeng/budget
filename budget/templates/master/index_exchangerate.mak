...
<div class="nav-tree">Master&nbsp;&nbsp;&gt;&nbsp;&nbsp;Exchange Rate&nbsp;&nbsp;&gt;&nbsp;&nbsp;Search</div>
...
<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
    <thead>
        ...
        <tr>
            ...
            <th width="100">Exchange Rate Value</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/${funcURL}/update?id=${u.id}" class="${'required link-text' if u.active==1 else 'link-text'}">${u.currency}</a>&nbsp;</td>
            <td>${u.value}&nbsp;</td>
            <td>${u.year}&nbsp;</td>
            <td>${u.month}&nbsp;</td>
        </tr>
